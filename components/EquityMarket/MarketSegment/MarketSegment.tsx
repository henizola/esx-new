        ...
        <div className='col-span-5 space-y-8  w-[100vw] lg:w-[auto]'>
          <div className='grid sm:grid-cols-5 gap-5'>
            <Card width='col-span-5 flex flex-col pb-3'>
              <h1 className="pt-[19px] pb-5 px-[20px]  bg-primary-blue text-white text-[24px] lg:text-[40px] font-normal font-['Open Sans']  leading-[normal]">
                Market Segments
              </h1>
              <Image
              ...
              <div className='flex w-full'>
                <div className='py-[20px] px-[20px] w-[100%] lg:w-[55%] space-y-[30px]'>
                  <main className=' '>
                    <h1 className="text-black text-[20px] lg:text-2xl font-normal font-['Open Sans'] flex items-center gap-5 ">
              ...
              <h1 className="col-span-5 pb-[20px]  lg:py-[30px] px-[20px] text-black text-[14px] lg:text-2xl font-normal font-['Open Sans']">
