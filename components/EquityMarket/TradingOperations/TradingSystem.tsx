  ...
  return (
    <div className='flex flex-col w-full p-0 m-0'>
      ...
      <div className='grid sm:grid-cols-7 gap-8 lg:px-28 py-7'>
        ...
        <div className='col-span-5 space-y-5 w-[100vw] h-[auto]'>
          <Card width='w-[100%] flex  flex-col pt-[40px] pb-[30px] px-[20px] shadow-[0]'>
            <h1 className="text-black text-[20px] md:text-[32px] ml-[11px] font-normal font-['Open Sans']">
              Trading calendar
            </h1>
            <hr className=' border border-primary-golden opacity-70 mt-[12px]' />
            <main className=' space-y-[15px] pt-[30px]'>
              <p className=" text-black text-[14px] md:text-base font-normal font-['Open Sans']">
          ...
          <div className='grid sm:grid-cols-2 gap-5'>
            <Card width='w-[100%] flex gap-4 flex-col shadow-[0] '>
              ...
              <main className='pb-[20px] px-[20px] flex flex-col h-full'>
                <h1 className="text-black text-[20px] md:text-2xl font-normal font-['Open Sans'] flex items-end gap-5 ">
