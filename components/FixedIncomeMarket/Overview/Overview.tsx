        ...
        <div className='flex flex-col w-full gap-5'>
          <Card width='w-[100%]  flex flex-row'>
            ...
            <div className='w-[62%] flex  flex-col py-7 px-5'>
              <p className='text-[12px] text-[#001F59]   font-semibold pb-6'>
                Overview{" "}
              </p>
              <h1 className='text-[30px]   font-normal pb-6'>
                Fixed income market{" "}
              </h1>

              <p className='text-[16px]   font-normal mt-2 pt-0 leading-6 text-[#707377] pb-14'>
          ...
          <Card width='w-[100%] px-6 py-7'>
            <div className='flex '>
              <div className='w-[100%] flex  flex-col  mt-0 pt-0'>
                <h1 className='text-[20px]   font-normal mt-0 pt-0'>
                  The following instruments are listed and traded in ESX’s Fixed
                  Income Market.{" "}
                </h1>

                <p className='w-[100%]  text-[16px]   font-light mt-2 pt-0 leading-6 text-[#707377]'>
