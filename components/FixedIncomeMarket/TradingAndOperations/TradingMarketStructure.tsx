      ...
      <Card width='w-[100%]  flex  flex-col pt-5 pb-[30px] px-10 shadow-[0]'>
        ...
        <main className=' space-y-[15px] pt-[30px]'>
          <p className=' text-black text-[14px] md:text-paragraphSmall font-light   '>
            ...
            unlisted securities market) occurs via ESX’s proprietary Automated
            Trading System (ATS).
          </p>
          <p className=' text-black text-[14px] md:text-paragraphSmall font-light   '>
            ESX adopts a hybrid market that provides both a central limit order
            book as well as platforms for bilateral and multilateral negotiated
            trading in the form of Requests for Quotes (RFQs). ESX’s central
            limit order book allows trading members and their clients to enter
            buy and sell orders anonymously where customer trades are executed
            using ESXs’ modern trading engine based on a transparent price-time
            priority mechanism of trade matching.
          </p>
          <p className=' text-black text-[14px] md:text-paragraphSmall font-light   '>
            The ATS seamlessly integrates with the CSD that ensures efficient
        ...
        <Card width='w-[100%] flex gap-4 flex-col shadow-[0] '>
          ...
          <main className=' pt-2 pb-7 px-10 flex flex-col h-full'>
            ...
            <p className='text-black text-paragraphSmall font-light  mt-4 flex'>
              ...
              <span className='ml-2'>
                The ESX shall open for trading on all business days in Ethiopia.
              </span>
            </p>
            ...
            <p className='text-black text-paragraphSmall font-light  mt-4 flex'>
              ...
              <span className='ml-2'>
                Unless otherwise specified by the Board of Directors of the ESX,
                the exchange shall be open for trading from 9:00 to 3:00 EAT, as
                follows{" "}
              </span>
            </p>
            ...
            <table className=' hidden lg:block  bg-white mt-5'>
              <thead>
                <tr className='bg-gray-100'>
                  ...
                  <th className='border text-left px-8 py-4'>Price Limit</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className='border text-left px-8 py-4'>Pre-open</td>
                  <td className='border text-left px-8 py-4'>9:00 - 9:30 AM</td>
                  <td className='border text-left px-8 py-4'>Main and GM</td>
            ...
            <p className='text-black text-paragraphSmall font-light  mt-4 flex'>
              ...
              <span className='ml-2'>
                In extraordinary circumstances, at the sole discretion of ESX,
                the exchange may authorize an extension of the trading hours
                past …3:30 PM on a particular trading day.
              </span>
            </p>
            ...
            <p className='text-black text-paragraphSmall font-light  mt-4 flex'>
              ...
              <span className='ml-2'>
                The Exchange will provide public notice of any extension of the
                trading day as promptly as practicable.
              </span>
            </p>
          </main>
        </Card>
        ...
        <Card width='w-[100%] flex gap-4 flex-col  shadow-[0]'>
          ...
          <main className=' pt-2 pb-7 px-10 flex flex-col h-full'>
            ...
            <table className='min-w-full bg-white mt-5'>
              <thead>
                <tr className='bg-gray-100'>
                  <th className='border text-left px-8 py-4 w-[30%]'>Date</th>
