    ...
    <Slider {...settings} className="relative ">
      <div className="flex flex-col ">
        <div className="relative ">
          ...
          />
          <div
            className="h-[400px] w-full relative -pt-64 px-[20%] z-20  "
          >
            ...
            <div className="max-w-[1020px] bg-white   absolute top-0 left-1/2 transform -translate-x-1/2 w-full px-[24px] py-[40px] mx-auto z-20 flex flex-col gap-5 ">
              <h2 className="text-center text-black text-[32px] font-semibold font-['Open Sans']">
                How do investors access the market ?
              </h2>
              <p className=" text-center text-black text-xl font-normal font-['Open Sans'] leading-relaxed">
          ...
          <p className="w-[780px] h-[350px] absolute top-64 left-1/2 transform -translate-x-1/2 text-center text-white text-xl z-20 font-normal font-['Open Sans'] leading-relaxed">
