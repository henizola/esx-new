        ...
        <div className='grid grid-cols-1 gap-3 w-[100%]'>
          <div className='grid grid-cols-2 gap-3 mt-4 '>
            <Card width='w-[100%] pb-10 h-[100%]'>
              <div className='flex flex-col p-0 mx-0'>
                <div className='h-[40vh]'>
                  <h1 className='text-[24px] px-10 mt-10  text-left text-primary-blue font-sans font-normal '>
                    What is CrowdEx?
                  </h1>
                  ...
                  <Link href='#' className='flex text-[16px] mb-5 px-10 '>
                    View more{" "}
                    <svg
                ...
                <div className='w-[100%] flex   flex-col  mt-0 pt-0'>
                  <h1 className='text-[24px] h-[77px] px-10 py-0  text-left text-white  w-[100%] bg-primary-blue font-sans font-normal '></h1>
            ...
            <Card width='w-[100%] pb-10 h-[100%]'>
              <div className='flex flex-col p-0 mx-0'>
                <div className='h-[40vh]'>
                  <div className='w-[100%] flex h-[45%]    mt-0 px-10 pt-5'>
                    <Image
                      height={200}
                      width={200}
                      src={youtube.src}
                      alt='manager'
                      className='w-[auto] object-cover h-[100%]'
                    />
                    <div className='height-[100%] '>
                      <Link
                        href='#'
                        className='flex text-[16px] mt-[85%]  pl-5  '
                      >
                        View more{" "}
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
