...
function CoursesAndPrograms() {
  ...
  return (
    <div className="w-full h-full  ">
      ...
      <div className="w-full min-h-[1000px] grid grid-cols-3 gap-y-0 gap-x-5 pt-5 ">
        {members.map((member, index) => {
          return (
            <div
              className="w-full h-[500px] flex flex-col flex-grow justify-center items-center mb-5 "
              key={index}
            >
