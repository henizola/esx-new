    ...
    <Card width='w-[100%]'>
      <div className='flex'>
        <div className='w-[100%] flex flex-col mb-8 mx-5'>
          <h1 className='text-[20px] lg:text-[32px]   font-normal border-b md:pt-8 md:pb-6 md:mb-7 py-5 mb-5'>
            Frequently asked questions{" "}
          </h1>
          <p className='text-[14px] md:text-[16px]   font-normal pb-7 border-b'>
